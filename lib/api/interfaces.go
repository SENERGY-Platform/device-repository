...
type Controller interface {
	...
	ListDeviceTypesV2(token string, limit int64, offset int64, sort string, filter []model.FilterCriteria) (result []model.DeviceType, err error, errCode int)
	...
	GetDeviceTypeSelectablesV2(query []model.FilterCriteria, pathPrefix string) (result []model.DeviceTypeSelectable, err error, code int)
