...
func testReadDeviceTypeCF(con *controller.Controller) func(t *testing.T) {
	return func(t *testing.T) {
		deviceType, err, code := con.ListDeviceTypes("", 100, 0, "", []model.FilterCriteria{{FunctionId: "urn:infai:ses:controlling-function:c54e2a89-1fb8-4ecb-8993-a7b40b355599", DeviceClassId: "urn:infai:ses:device-class:14e56881-16f9-4120-bb41-270a43070c86", AspectId: ""}})
