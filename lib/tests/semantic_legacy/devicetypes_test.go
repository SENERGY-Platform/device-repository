...
func testReadDeviceTypeCF(con *controller.Controller) func(t *testing.T) {
	return func(t *testing.T) {
		deviceType, err, code := con.ListDeviceTypes("", 100, 0, "", []model.FilterCriteria{{FunctionId: "urn:infai:ses:controlling-function:c54e2a89-1fb8-4ecb-8993-a7b40b355599", DeviceClassId: "urn:infai:ses:device-class:14e56881-16f9-4120-bb41-270a43070c86", AspectId: ""}}, nil, false)
...
func testReadDeviceType_1MF(con *controller.Controller) func(t *testing.T) {
	return func(t *testing.T) {
		...
		deviceType, err, code := con.ListDeviceTypes("", 100, 0, "", []model.FilterCriteria{{FunctionId: "urn:infai:ses:measuring-function:f2c1a22f-a49e-4549-9833-62f0994afec0", DeviceClassId: "", AspectId: "urn:infai:ses:aspect:a14c5efb-b0b6-46c3-982e-9fded75b5ab6"}}, nil, false)
...
func testReadDeviceType_1MF_variante2(con *controller.Controller) func(t *testing.T) {
	return func(t *testing.T) {
		...
		deviceType, err, code := con.ListDeviceTypes("", 100, 0, "", []model.FilterCriteria{{FunctionId: "urn:infai:ses:measuring-function:f2769eb9-b6ad-4f7e-bd28-e4ea043d2f8b", DeviceClassId: "", AspectId: "urn:infai:ses:aspect:a14c5efb-b0b6-46c3-982e-9fded75b5ab6"}}, nil, false)
...
func testReadDeviceType_2MF_sameAspect(con *controller.Controller) func(t *testing.T) {
	return func(t *testing.T) {
		...
		deviceType, err, code := con.ListDeviceTypes("", 100, 0, "", []model.FilterCriteria{{FunctionId: "urn:infai:ses:measuring-function:f2c1a22f-a49e-4549-9833-62f0994afec0", DeviceClassId: "", AspectId: "urn:infai:ses:aspect:a14c5efb-b0b6-46c3-982e-9fded75b5ab6"},
			{FunctionId: "urn:infai:ses:measuring-function:0e19d094-70c6-402c-8523-3aaff2ce6dd9", DeviceClassId: "", AspectId: "urn:infai:ses:aspect:a14c5efb-b0b6-46c3-982e-9fded75b5ab6"}}, nil, false)
