...
const docTemplatedevicerepository = `{
    ...
    "paths": {
        ...
        "/devices-batch/connection-state": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "device id to connected true/false",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.LastUpdateTimestamp"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.FunctionListOptions"
                        }
                    }
                ],
                "responses": {
