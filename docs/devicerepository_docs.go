...
const docTemplatedevicerepository = `{
        ...
        "/import-from": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "options containing information what should be imported from where; filter_resource_types and filter_ids are optional but empty lists result in empty results; filter_resource_types allows filtering by resource-types like device-type; filter_ids allows filtering by resource id; ref documentation of GET /export",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
...
// SwaggerInfodevicerepository holds exported Swagger Info so clients can modify it
var SwaggerInfodevicerepository = &swag.Spec{
	Version:          "0.1",
	Host:             "",
	BasePath:         "/",
	Schemes:          []string{},
	...
	Description:      "",
	InfoInstanceName: "devicerepository",
	SwaggerTemplate:  docTemplatedevicerepository,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfodevicerepository.InstanceName(), SwaggerInfodevicerepository)
}
